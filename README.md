...
Future Improvements (Notes to Myself)

If I come back to this project, focus on these in order:
...
Strategic Note (Career Perspective)
...
However, it is not a primary portfolio project for backend or AI roles.

If revisited, position it as:

“A turn-based strategy engine modeling complex game rules and state transitions.”
